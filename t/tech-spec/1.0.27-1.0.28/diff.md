# Comparing `tmp/tech-spec-1.0.27.tar.gz` & `tmp/tech-spec-1.0.28.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tech-spec-1.0.27.tar", last modified: Fri Aug  4 06:38:25 2023, max compression
+gzip compressed data, was "tech-spec-1.0.28.tar", last modified: Sat Aug  5 11:49:00 2023, max compression
```

## Comparing `tech-spec-1.0.27.tar` & `tech-spec-1.0.28.tar`

### file list

```diff
@@ -1,13 +1,25 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-04 06:38:25.097062 tech-spec-1.0.27/
--rw-r--r--   0 runner    (1001) docker     (123)      224 2023-08-04 06:38:25.097062 tech-spec-1.0.27/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-08-04 06:38:14.000000 tech-spec-1.0.27/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      115 2023-08-04 06:38:14.000000 tech-spec-1.0.27/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-08-04 06:38:25.097062 tech-spec-1.0.27/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      532 2023-08-04 06:38:14.000000 tech-spec-1.0.27/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-04 06:38:25.097062 tech-spec-1.0.27/tech_spec.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      224 2023-08-04 06:38:25.000000 tech-spec-1.0.27/tech_spec.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      186 2023-08-04 06:38:25.000000 tech-spec-1.0.27/tech_spec.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-08-04 06:38:25.000000 tech-spec-1.0.27/tech_spec.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-08-04 06:38:25.000000 tech-spec-1.0.27/tech_spec.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-04 06:38:25.097062 tech-spec-1.0.27/techspec/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-08-04 06:38:14.000000 tech-spec-1.0.27/techspec/__init__.py
...
### Comparing `tech-spec-1.0.27/setup.py` & `tech-spec-1.0.28/setup.py`
