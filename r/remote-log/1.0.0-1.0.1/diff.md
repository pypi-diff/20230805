# Comparing `tmp/remote-log-1.0.0.tar.gz` & `tmp/remote-log-1.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "remote-log-1.0.0.tar", last modified: Sat Aug  5 13:50:25 2023, max compression
+gzip compressed data, was "remote-log-1.0.1.tar", last modified: Sat Aug  5 13:58:53 2023, max compression
```

## Comparing `remote-log-1.0.0.tar` & `remote-log-1.0.1.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 brainspoof   (501) staff       (20)        0 2023-08-05 13:50:25.449527 remote-log-1.0.0/
--rw-r--r--   0 brainspoof   (501) staff       (20)     1039 2023-08-05 13:50:25.449391 remote-log-1.0.0/PKG-INFO
-drwxr-xr-x   0 brainspoof   (501) staff       (20)        0 2023-08-05 13:50:25.448502 remote-log-1.0.0/remote_log/
--rw-r--r--   0 brainspoof   (501) staff       (20)       25 2023-08-04 20:15:20.000000 remote-log-1.0.0/remote_log/__init__.py
--rw-r--r--   0 brainspoof   (501) staff       (20)       34 2023-08-05 13:41:02.000000 remote-log-1.0.0/remote_log/__main__.py
--rw-r--r--   0 brainspoof   (501) staff       (20)     2540 2023-08-05 13:16:24.000000 remote-log-1.0.0/remote_log/remote_log.py
--rw-r--r--   0 brainspoof   (501) staff       (20)     2180 2023-08-05 11:12:34.000000 remote-log-1.0.0/remote_log/sysinfo.py
--rw-r--r--   0 brainspoof   (501) staff       (20)       28 2023-08-04 20:15:20.000000 remote-log-1.0.0/remote_log/tests.py
-drwxr-xr-x   0 brainspoof   (501) staff       (20)        0 2023-08-05 13:50:25.449196 remote-log-1.0.0/remote_log.egg-info/
--rw-r--r--   0 brainspoof   (501) staff       (20)     1039 2023-08-05 13:50:25.000000 remote-log-1.0.0/remote_log.egg-info/PKG-INFO
--rw-r--r--   0 brainspoof   (501) staff       (20)      290 2023-08-05 13:50:25.000000 remote-log-1.0.0/remote_log.egg-info/SOURCES.txt
--rw-r--r--   0 brainspoof   (501) staff       (20)        1 2023-08-05 13:50:25.000000 remote-log-1.0.0/remote_log.egg-info/dependency_links.txt
--rw-r--r--   0 brainspoof   (501) staff       (20)       27 2023-08-05 13:50:25.000000 remote-log-1.0.0/remote_log.egg-info/requires.txt
--rw-r--r--   0 brainspoof   (501) staff       (20)       11 2023-08-05 13:50:25.000000 remote-log-1.0.0/remote_log.egg-info/top_level.txt
--rw-r--r--   0 brainspoof   (501) staff       (20)       38 2023-08-05 13:50:25.449575 remote-log-1.0.0/setup.cfg
--rw-r--r--   0 brainspoof   (501) staff       (20)     1276 2023-08-05 13:41:51.000000 remote-log-1.0.0/setup.py
...
### Comparing `remote-log-1.0.0/PKG-INFO` & `remote-log-1.0.1/PKG-INFO`
...
### Comparing `remote-log-1.0.0/remote_log/remote_log.py` & `remote-log-1.0.1/remote_log/remote_log.py`

 * *Files identical despite different names*

### Comparing `remote-log-1.0.0/remote_log/sysinfo.py` & `remote-log-1.0.1/remote_log/sysinfo.py`

 * *Files identical despite different names*

### Comparing `remote-log-1.0.0/remote_log.egg-info/PKG-INFO` & `remote-log-1.0.1/remote_log.egg-info/PKG-INFO`
...
### Comparing `remote-log-1.0.0/setup.py` & `remote-log-1.0.1/setup.py`
